...
const GooeyNav = ({
  ...
  const makeParticles = element => {
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      setTimeout(() => {
        ...
        particle.style.setProperty('--color', `var(--color-${p.color}, #9333ea)`);
  ...
  const handleClick = (e, index) => {
    ...
    // Call the custom onClick handler if it exists
    ...
    <>
      ...
      <style>
        {`
          ...
          .point {
            background: radial-gradient(circle, white 0%, white 30%, var(--color) 70%, var(--color) 100%);
            opacity: 1;
            ...
            {items.map((item, index) => (
              ...
              >
                <a
                  ...
                  className="outline-none py-[0.4em] px-[0.6em] md:py-[0.6em] md:px-[1em] inline-block "
                >
                  {item.label}
                </a>
              </li>
